...
TurboPack MustangpeakEasyListview package names have the following form:

EasyListviewD.bpl        (Delphi Runtime for all platforms)
EasyListviewDD.bpl       (Delphi Runtime for the VCL)
...
To install TurboPack MustangpeakEasyListview into your IDE, take the following
steps:

  1. Unzip the release files into a directory (e.g., d:\MustangpeakEasyListview).

  2. Start RAD Studio.

  3. Add the source subdirectory (e.g., d:\MustangpeakEasyListview\source) to the
     IDE's library path. For C++Builder, add the hpp subdirectory
     (e.g., d:\MustangpeakEasyListview\source\hpp\Win32\Release) to the IDE's system include path.
